...
const personSchema = {
  ...
  worksFor: {
    ...
    url: "https://www.rightfixhandyman.com",
  },
  url: "https://www.rightfixhandyman.com/about",
  sameAs: [
  ...
  description:
    "Owner of RightFix Handyman in Waco, TX. Background-checked pro with 11+ years helping Central Texas homes and businesses. Flat-rate pricing, 1-Year Workmanship Warranty.",
};
    ...
    <section className={styles.authorBio} aria-label="About the Author">
      ...
      <div className={styles.card}>
        ...
        <div className={styles.content}>
          <p className={styles.role}>Owner & Lead Handyman · RightFix Handyman</p>
          <h2 className={styles.title}>Sam Ortiz</h2>

          <p className={styles.description}>
            11+ years as a background-checked pro serving Central Texas
          ...
          <div className={styles.footer}>
            <a
              ...
              aria-label="Connect with RightFix Handyman on Facebook"
              onClick={() => trackEvent({
                eventType:    'click',
