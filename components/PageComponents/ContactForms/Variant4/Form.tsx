...
const SERVICES = [
  { icon: faFan,             label: 'General Home Repairs',        sub: 'Everyday fixes and hardware' },
  { icon: faFire,            label: 'Drywall Patching', sub: 'Holes, cracks, texture match' },
  { icon: faWrench,          label: 'Door & Window Fixes',  sub: 'Sticky doors, weatherstrip, hardware' },
  { icon: faFilter,          label: 'TV Mounting & Assembly',     sub: 'Mounts, furniture, shelves' },
  { icon: faThermometerHalf, label: 'Caulking & Weatherproofing',       sub: 'Tubs, windows, exterior gaps' },
  { icon: faWind,            label: 'Honey-Do Lists',       sub: 'Batch small projects in one visit' },
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successState}
                  ...
                  <p className={styles.successText}>
                    A RightFix specialist will reach out about your <strong>{selectedService}</strong> service.
                  </p>
