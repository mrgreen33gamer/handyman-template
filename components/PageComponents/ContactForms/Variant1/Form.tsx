...
const TRUST_CHIPS = [
  ...
  { icon: faShieldHalved, text: 'Background-Checked · Insured' },
  { icon: faStar,         text: '4.9★ · 1,800+ reviews' },
];
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A RightFix specialistnician will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12548009900"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 800-9900', section: 'ContactForm-V1' })}>
                          Call (254) 800-9900
                        </a>
                      </span>
                    </div>
