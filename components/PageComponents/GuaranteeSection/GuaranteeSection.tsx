...
const DEFAULT_GUARANTEES: Guarantee[] = [
  ...
  },
  {
    ...
    description:
      "Every job we complete is covered by a 1-Year Workmanship Warranty. If our labor fails within a year, we make it right.",
  },
  {
    icon: faRotateLeft,
  ...
  },
  {
    ...
    description:
      "Every pro who enters your home is background-checked, bonded, and insured. No random day labor — ever.",
  },
  {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.leftCol}>
          ...
          <p className={styles.body}>
            Every handyman in Central Texas makes promises. We back ours in writing — with flat-rate pricing, background-checked pros, and a 1-Year Workmanship Warranty on every job we touch.
          </p>
          <Link
            href={ctaLink}
          ...
          <div className={styles.ratingRow}>
            ...
            <span className={styles.ratingText}>4.9 · 1,800+ verified Google reviews</span>
          </div>
        </div>
