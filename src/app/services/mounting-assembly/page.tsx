// RightFix Handyman — TV Mounting & Assembly Service Page
"use client";
...
export default function ServicePage() {
  const expectations = [
    ...
    { icon: faCheckCircle, title: "Clean, Professional Finish", description: "We locate studs, use proper anchors, level every mount, and manage cables so the finish looks intentional — not temporary." },
  ...
  const localAreas = [
    { town: "Waco", benefit: "Home base — fastest scheduling for mounting.", badge: "Home Base" },
  ...
  const faq = [
    { question: "Do you hide TV cables?", answer: "Yes — in-wall cable routing when wall construction allows, or clean external channel options when it does not. We discuss options before drilling." },
    { question: "How much does tv mounting & assembly cost in Waco?", answer: "Most jobs are quoted flat-rate after a quick scope. Pricing depends on materials and complexity — call (254) 800-9900 for a free estimate." },
  ...
  return (
    <main className={styles.pageWrapper}>
      <Breadcrumb crumbs={[
        ...
        { label: "TV Mounting & Assembly" },
      ]} />
      <SectionIntro title="TV Mounting & Assembly in Waco, TX" subtitle={"Secure TV mounts, furniture assembly, shelves, and wall anchors — level, stud-safe, and cable-clean with a 1-Year Workmanship Warranty."} />
      ...
      <div className={styles.section}><LocalServiceAreas cityName="Waco" areas={localAreas} servicePath="services/mounting-assembly" title="TV Mounting & Assembly Across Central Texas" /></div>
      <div className={styles.section}><ValueComparison rows={comparisonRows} /></div>
      <div className={styles.section}><FAQ cityName="Waco" faq={faq} title="TV Mounting & Assembly FAQs" /></div>
      <CTABanner
      ...
      <div className={styles.section}>
        <Variant4 title="Schedule TV Mounting & Assembly" cityName="Waco" slug="services/mounting-assembly" spot="mounting-assembly-page-form" formVariant={2} />
      </div>
    </main>
  );
}
