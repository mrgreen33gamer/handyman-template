// RightFix Handyman — Honey-Do Lists Service Page
"use client";
...
export default function ServicePage() {
  const expectations = [
    ...
    { icon: faCheckCircle, title: "Clean, Professional Finish", description: "Send us the list. We sequence tasks for efficiency, quote the package, and knock out as much as possible in a single visit." },
  ...
  const localAreas = [
    { town: "Waco", benefit: "Home base — fastest scheduling for honey-do.", badge: "Home Base" },
  ...
  const faq = [
    { question: "Is there a minimum number of tasks?", answer: "No hard minimum. Single tasks are welcome; multi-item lists get the best value because setup time is shared across jobs." },
    { question: "How much does honey-do lists cost in Waco?", answer: "Most jobs are quoted flat-rate after a quick scope. Pricing depends on materials and complexity — call (254) 800-9900 for a free estimate." },
  ...
  return (
    <main className={styles.pageWrapper}>
      <Breadcrumb crumbs={[
        ...
        { label: "Honey-Do Lists" },
      ]} />
      <SectionIntro title="Honey-Do Lists in Waco, TX" subtitle={"Batch your small projects into one efficient visit — flat-rate packaging, background-checked pros, no job too small."} />
      ...
      <div className={styles.section}><LocalServiceAreas cityName="Waco" areas={localAreas} servicePath="services/honey-do-lists" title="Honey-Do Lists Across Central Texas" /></div>
      <div className={styles.section}><ValueComparison rows={comparisonRows} /></div>
      <div className={styles.section}><FAQ cityName="Waco" faq={faq} title="Honey-Do Lists FAQs" /></div>
      <CTABanner
      ...
      <div className={styles.section}>
        <Variant4 title="Schedule Honey-Do Lists" cityName="Waco" slug="services/honey-do-lists" spot="honey-do-lists-page-form" formVariant={2} />
      </div>
    </main>
  );
}
