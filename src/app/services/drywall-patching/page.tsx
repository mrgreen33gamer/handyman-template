// RightFix Handyman — Drywall Patching Service Page
"use client";
...
export default function ServicePage() {
  const expectations = [
    ...
    { icon: faCheckCircle, title: "Clean, Professional Finish", description: "We match texture as closely as possible, sand smooth, and leave a paint-ready surface so your next coat looks seamless." },
  ...
  const localAreas = [
    { town: "Waco", benefit: "Home base — fastest scheduling for drywall.", badge: "Home Base" },
  ...
  const faq = [
    { question: "Can you match existing texture?", answer: "Yes for most common Central Texas textures (orange peel, knockdown, smooth). We blend carefully; perfect match depends on age and previous coats." },
    { question: "How much does drywall patching cost in Waco?", answer: "Most jobs are quoted flat-rate after a quick scope. Pricing depends on materials and complexity — call (254) 800-9900 for a free estimate." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro title="Drywall Patching in Waco, TX" subtitle={"Holes, cracks, water damage, and texture match so walls look whole again — paint-ready finish, flat-rate pricing, 1-Year Workmanship Warranty."} />
      ...
      <div className={styles.section}><LocalServiceAreas cityName="Waco" areas={localAreas} servicePath="services/drywall-patching" title="Drywall Patching Across Central Texas" /></div>
      <div className={styles.section}><ValueComparison rows={comparisonRows} /></div>
      <div className={styles.section}><FAQ cityName="Waco" faq={faq} title="Drywall Patching FAQs" /></div>
      <CTABanner
      ...
      <div className={styles.section}>
        <Variant4 title="Schedule Drywall Patching" cityName="Waco" slug="services/drywall-patching" spot="drywall-patching-page-form" formVariant={2} />
      </div>
    </main>
  );
}
