// RightFix Handyman — General Home Repairs Service Page
"use client";
...
export default function ServicePage() {
  const expectations = [
    ...
    { icon: faCheckCircle, title: "Clean, Professional Finish", description: "We scope the issue, quote flat-rate, and complete repairs cleanly without turning a small fix into a remodel upsell." },
  ...
  const localAreas = [
    { town: "Waco", benefit: "Home base — fastest scheduling for general repairs.", badge: "Home Base" },
  ...
  const faq = [
    { question: "What counts as general home repair?", answer: "Most non-permit residential fixes: hardware, fixtures, minor plumbing/electrical swaps within code comfort, trim, and similar tasks. We will tell you honestly if a licensed specialty trade is required." },
    { question: "How much does general home repairs cost in Waco?", answer: "Most jobs are quoted flat-rate after a quick scope. Pricing depends on materials and complexity — call (254) 800-9900 for a free estimate." },
  ...
  const crossServices = [
    ...
    { icon: faWrench, title: "Door & Window Fixes", body: "Learn more about our doors & windows services.", link: "/services/door-window-fixes" },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro title="General Home Repairs in Waco, TX" subtitle={"Everyday home repairs done right — faucets, hardware, trim, fixtures, and the fixes that keep your house working. Flat-rate quotes and a 1-Year Workmanship Warranty."} />
      ...
      <div className={styles.section}><LocalServiceAreas cityName="Waco" areas={localAreas} servicePath="services/general-repairs" title="General Home Repairs Across Central Texas" /></div>
      <div className={styles.section}><ValueComparison rows={comparisonRows} /></div>
      <div className={styles.section}><FAQ cityName="Waco" faq={faq} title="General Home Repairs FAQs" /></div>
      <CTABanner
      ...
      <div className={styles.section}>
        <Variant4 title="Schedule General Home Repairs" cityName="Waco" slug="services/general-repairs" spot="general-repairs-page-form" formVariant={2} />
      </div>
    </main>
  );
}
