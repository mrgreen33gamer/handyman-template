// RightFix Handyman — Caulking & Weatherproofing Service Page
"use client";
...
export default function ServicePage() {
  const expectations = [
    ...
    { icon: faCheckCircle, title: "Clean, Professional Finish", description: "We remove failed caulk, prep surfaces, and apply the right sealant for wet areas, paintability, or exterior UV exposure." },
  ...
  const localAreas = [
    { town: "Waco", benefit: "Home base — fastest scheduling for caulking.", badge: "Home Base" },
  ...
  const faq = [
    { question: "How often should exterior caulk be replaced?", answer: "Every 5–10 years depending on sun exposure and product. Cracking, peeling, or gaps that let water in mean it is time." },
    { question: "How much does caulking & weatherproofing cost in Waco?", answer: "Most jobs are quoted flat-rate after a quick scope. Pricing depends on materials and complexity — call (254) 800-9900 for a free estimate." },
  ...
  return (
    <main className={styles.pageWrapper}>
      <Breadcrumb crumbs={[
        ...
        { label: "Caulking & Weatherproofing" },
      ]} />
      <SectionIntro title="Caulking & Weatherproofing in Waco, TX" subtitle={"Tub surrounds, windows, exterior gaps, and door thresholds sealed against moisture and Texas heat — clean lines, durable sealants."} />
      ...
      <div className={styles.section}><LocalServiceAreas cityName="Waco" areas={localAreas} servicePath="services/caulking-weatherproofing" title="Caulking & Weatherproofing Across Central Texas" /></div>
      <div className={styles.section}><ValueComparison rows={comparisonRows} /></div>
      <div className={styles.section}><FAQ cityName="Waco" faq={faq} title="Caulking & Weatherproofing FAQs" /></div>
      <CTABanner
      ...
      <div className={styles.section}>
        <Variant4 title="Schedule Caulking & Weatherproofing" cityName="Waco" slug="services/caulking-weatherproofing" spot="caulking-weatherproofing-page-form" formVariant={2} />
      </div>
    </main>
  );
}
