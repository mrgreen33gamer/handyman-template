...
// RightFix Handyman — Service Areas Page
'use client';
...
const SERVICE_AREAS = [
  {
    ...
    badge:       'Home Base',
    description: 'Our headquarters. Fastest response times, same-day service available 7 days a week. Full handyman coverage: general repairs, drywall, door and window fixes, mounting, caulking, and honey-do lists across all of Waco.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       'Primary Area',
    description: 'Full handyman coverage for Hewitt homes and businesses. Fast dispatch from our Waco base — typically under 45 minutes.',
    highlights:  ['45-min dispatch', 'Residential & commercial', 'Home repairs'],
  },
  {
    city:        'Woodway',
    slug:        'woodway-tx',
    ...
    highlights:  ['Flat-rate pricing', '1-Year Workmanship Warranty', 'background-checked'],
  },
  {
    city:        'Bellmead',
    slug:        'bellmead-tx',
    county:      'McLennan County',
    badge:       '',
    description: 'Reliable handyman service for Bellmead residents and businesses. General repairs, mounting, and caulking — same-day when available.',
    highlights:  ['Residential & commercial', 'background-checked pros', 'No contracts'],
  },
  {
    city:        'China Spring',
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Rural and residential handyman service for the China Spring area. We make the drive — flat-rate pricing applies just the same.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Handyman repairs for McGregor homes and light commercial properties.',
    highlights:  ['Shop & residential', 'Home repairs', 'Same-day when available'],
  },
  {
    city:        'Killeen',
    slug:        'killeen-tx',
    county:      'Bell County',
    badge:       '',
    description: 'Handyman repairs and honey-do lists for Killeen and Fort Cavazos area homes and businesses. Military-friendly scheduling.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Full-service handyman coverage for Temple. Medical district and surrounding neighborhoods served. Full residential and commercial handyman service.',
    ...
    <main className={styles.page}>
        ...
        <div className={styles.heroInner}>
          ...
          >
            ...
            <p className={styles.heroSub}>
              Based in Waco, serving all of Central Texas. Flat-rate pricing, background-checked pros, and a 1-Year Workmanship Warranty — no matter where you are.
            </p>
            <div className={styles.heroActions}>
              <a href="tel:+12548009900" className={styles.heroCTAPrimary}>
              ...
              return (
                ...
                >
                  ...
                  <div className={styles.areaFooter}>
                    <a href="tel:+12548009900" className={styles.areaCallBtn}>
      ...
      <section className={styles.unlisted}>
        <div className={styles.unlistedInner}>
          ...
          <a href="tel:+12548009900" className={styles.unlistedCTA}>
            Call (254) 800-9900
          </a>
        </div>
      </section>
