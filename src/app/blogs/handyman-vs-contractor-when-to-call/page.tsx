...
const sections: BlogSection[] = [
  {
    type: 'prose',
    body: "Not every project needs a general contractor. Learn when a skilled handyman is the smarter, faster, and more affordable call — and when you should hire a specialty trade. RightFix Handyman helps homeowners across Waco, Temple, and Killeen make the right call before money is wasted on the wrong trade.",
  },
  {
    type: 'cards',
  ...
  return (
    <>
      ...
      <BlogCTA
        ...
        buttonHref="/contact"
      />
      <NewsletterSignup variant={1} spot="handyman-vs-contractor-blog" />
    </>
  );
}
