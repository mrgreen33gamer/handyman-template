...
const sections: BlogSection[] = [
  {
    type: 'prose',
    body: "Patches that show through paint are almost always a prep problem. Here is how to patch, texture-match, and sand so your next paint job looks seamless. RightFix Handyman helps homeowners across Waco, Temple, and Killeen make the right call before money is wasted on the wrong trade.",
  },
  {
    type: 'cards',
  ...
  return (
    <>
      ...
      <BlogCTA
        ...
        buttonHref="/contact"
      />
      <NewsletterSignup variant={1} spot="drywall-repair-blog" />
    </>
  );
}
